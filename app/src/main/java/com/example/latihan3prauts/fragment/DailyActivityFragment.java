...
public class DailyActivityFragment extends Fragment {
    ...
    public DailyActivityFragment() {
        FriendModel us1 = new FriendModel(R.drawable.instagram, "Adamfanta", "instagram");
        FriendModel us2 = new FriendModel(R.drawable.whatsapp, "08782405752", "whatsapp");
        FriendModel us3 = new FriendModel(R.drawable.facebook, "Adam Aris Rizaldy", "facebook");
